...
//        try {
//            new SimulatedDevice(this, this, getResources().openRawResource(R.raw.sampleframes),
//                        100);
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
    ...
    // start Frame Processor delegate
    @Override
    public void onFrameProcessed(RenderedImage renderedImage) {
        ...
        final ImageView ivThermal = findViewById(R.id.iv_thermal_image);
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                ivThermal.setImageBitmap(imageBitmap);
            }
        });
    }
